...
public class WebController {
     ...
     * @return
     */
    @RequestMapping(value = "/string/{something}", method = RequestMethod.GET)
    Iterable<String> splitString(@PathVariable("something") String x) {
        return Splitter.on(',').omitEmptyStrings().split(x);
    }
